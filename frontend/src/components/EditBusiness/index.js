...
function EditBusiness() {
    ...
    const handleSubmit = (e) => {
        ...
        const newbusiness = {id: businessId, name, imgUrl, owner_id, body, type, cusine, openTimes: openingTimes, closeTimes: closingTimes, location, lat, lng, rating: rating, likes};
